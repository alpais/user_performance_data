...
The initial ROS bag files containing the sensor data are not provided due to their large size (total 39.6 GB). We provide: 
 * the data obtained after bag parsing - see [rawdata_sensors_parsed](https://github.com/alpais/user_performance_data/tree/master/S0_raw_data_parsing/raw_data/rawdata_sensors_parsed) 
